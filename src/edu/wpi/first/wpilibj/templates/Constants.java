...
public class Constants {
    public static final double FLINGER_POWER_SAVING_MODE = 0.3;
    ...
    public static final int TILT_PYRIMID_BACK = (-519);
    public static final int TILT_PYRIMID_MIDDLE = (-600);
    public static final int TILT_PYRIMID_FRONT = (-750);
